...
RUN apt-get update && \
    DEBIAN_FRONTEND=noninteractive apt-get install -y pkg-config libssl-dev cmake clang curl git-all build-essential binutils-dev libunwind-dev libblocksruntime-dev liblzma-dev
